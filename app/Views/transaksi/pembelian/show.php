                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($dataPembelian->getResult() as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?= number_to_currency($data->harga_pembelian, 'IDR', 'id_ID', 2) ?></td>
                                                <td class="text-center"><?= $data->jumlah_pembelian ?></td>
                                                <td class="text-center"><?= number_to_currency($data->subtotal_pembelian, 'IDR', 'id_ID', 2) ?></td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php } ?>
                                    </tbody>
